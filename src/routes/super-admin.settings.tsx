...
export const Route = createFileRoute("/super-admin/settings")({
  head: () => ({ meta: [{ title: "Settings · Sudsly HQ" }] }),
  component: Settings,
});
...
function Settings() {
  return (
    <div className="space-y-5">
      <PageHeader title="Platform settings" subtitle="Global configuration for the Sudsly platform." />
      <div className="rounded-2xl border border-border bg-card p-5 space-y-3">
        <Row label="Platform name" value="Sudsly" />
        <Row label="Default trial" value="14 days" />
        <Row label="Support email" value="support@sudsly.io" />
