    ...
    <div className="space-y-5">
      <div className="rounded-2xl bg-ink text-ink-foreground p-6 lg:p-8 flex flex-wrap items-center justify-between gap-4">
        <div className="max-w-xl">
          ...
          <h1 className="font-display text-3xl sm:text-4xl font-semibold mt-2">Your laundry day, handled.</h1>
          <p className="text-sm text-ink-foreground/70 mt-2">Tap below to schedule a pickup. We'll be at your door in under 90 minutes.</p>
        </div>
